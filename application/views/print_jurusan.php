  ...
  <body>
    <div class="container">
      <div class="">
        ...
        <h3 align="left">
          Data Jurusan <?php echo $nama; ?>
        </h3>
      </div>
<?php
          foreach($jurusan as $s) {
        ?>
        <br><b>Kode Jurusan :</b> <?php echo $s['kode_jurusan']; ?><br>
        <b>Nama Jurusan :</b> <?php echo $s['nama_jurusan']; ?><br><br>
        <?php } ?>
        <h3>Data siswa PKL Jurusan <?php echo $nama; ?> </h3>
